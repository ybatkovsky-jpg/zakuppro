...
- [ ] **T02: Replace Projects API Routes with FastAPI Proxy** `est:2h`
  ## Why
...
- [ ] **T03: Replace Suppliers API Routes with FastAPI Proxy** `est:1h`
  ## Why
...
- [ ] **T04: Replace Warehouse/Stock API Routes with FastAPI Proxy** `est:1.5h`
  ## Why
...
- [ ] **T05: Replace Invoices API Routes with FastAPI Proxy** `est:1.5h`
  ## Why
...
- [ ] **T06: Replace Analytics API Routes with FastAPI Proxy** `est:1h`
  ## Why
