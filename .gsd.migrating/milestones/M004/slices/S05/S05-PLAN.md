...
- [x] **T01: Add Filter and Search to UnresolvedTransaction List Endpoint** `est:1h`
...
- [x] **T02: Add Invoice Candidate Suggestion Endpoint** `est:1h`
...
- [x] **T03: Add Single Manual Match Endpoint** `est:1.5h`
...
- [x] **T05: Add Audit History Endpoint and Extend TransactionMatchingAudit** `est:1.5h`
...
- [x] **T06: Write API Unit Tests** `est:2h`
...
- [x] **T07: Write Integration Test for Manual Matching Workflow** `est:2h`
...
- [x] **T08: Restore test_client Fixture and Run Full Test Suite** `est:30m`
