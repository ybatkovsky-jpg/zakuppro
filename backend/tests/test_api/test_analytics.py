...
class TestDashboardMetricsEmptyDB:
    ...
    def test_dashboard_metrics_empty_db(self, auth_client: TestClient):
...
class TestDashboardMetricsSingleRecord:
    ...
    def test_dashboard_metrics_single_paid_invoice(self, auth_client: TestClient):
        """GET returns 200 with correct counts for single paid invoice."""
        # First create a supplier, project, and purchase order
        supplier_response = auth_client.post("/api/suppliers/", json={
            "name": "Test Supplier",
        ...
        po_response = auth_client.post("/api/purchase-orders/", json={
        ...
        # Create invoice
        now = datetime.utcnow()
        invoice_response = auth_client.post("/api/invoices/", json={
        ...
        payment_response = auth_client.post("/api/payments/", json={
    ...
    def test_dashboard_metrics_single_unpaid_invoice(self, auth_client: TestClient):
    ...
    def test_dashboard_metrics_single_pending_invoice(self, auth_client: TestClient):
...
class TestDashboardMetricsMultipleRecords:
    ...
    def test_dashboard_metrics_multiple_records(self, auth_client: TestClient):
        ...
        pending_response = auth_client.post("/api/invoices/", json={
            "purchase_order_id": po_id,
            "status": "Сверен"
        })
...
class TestDashboardMetricsDateRangeFiltering:
    ...
    def test_dashboard_metrics_with_date_range(self, auth_client: TestClient):
        ...
        recent_invoice_response = auth_client.post("/api/invoices/", json={
            "purchase_order_id": po_id,
            "status": "Оплачен"
        })
...
class TestDashboardMetricsDateRangeValidation:
    ...
    def test_dashboard_metrics_range_exceeds_one_year(self, auth_client: TestClient):
    ...
    def test_dashboard_metrics_start_after_end(self, auth_client: TestClient):
    ...
    def test_dashboard_metrics_partial_date_range(self, auth_client: TestClient):
...
class TestDashboardMetricsDefaultDateRange:
    ...
    def test_dashboard_metrics_default_to_last_30_days(self, auth_client: TestClient):
...
class TestPaymentDynamicsEmptyDB:
    ...
    def test_payment_dynamics_empty_db(self, auth_client: TestClient):
...
class TestPaymentDynamicsSingleRecord:
    ...
    def test_payment_dynamics_single_payment(self, auth_client: TestClient):
...
class TestPaymentDynamicsGrouping:
    ...
    def test_payment_dynamics_group_by_day(self, auth_client: TestClient):
...
class TestPaymentDynamicsDateRangeValidation:
    ...
    def test_payment_dynamics_range_exceeds_one_year(self, auth_client: TestClient):
        """GET returns 400 when date range exceeds 1 year."""
        now = datetime.utcnow()
        period_start = (now - timedelta(days=400)).isoformat()
        period_end = now.isoformat()
    ...
    def test_payment_dynamics_invalid_group_by(self, auth_client: TestClient):
...
class TestExportTransactionsEmptyDB:
    ...
    def test_export_transactions_empty_db(self, auth_client: TestClient):
...
class TestExportTransactionsWithRecords:
    ...
    def test_export_transactions_with_data(self, auth_client: TestClient):
    ...
    def test_export_transactions_with_date_filter(self, auth_client: TestClient):
        ...
        old_payment_response = auth_client.post("/api/payments/", json={
            "invoice_id": invoice_id,
            "amount": 10000.00,
        ...
        recent_payment_response = auth_client.post("/api/payments/", json={
            "invoice_id": invoice_id,
            "amount": 20000.00,
    ...
    def test_export_transactions_limit(self, auth_client: TestClient):
        ...
        # Export with limit=3
        response = auth_client.get("/api/analytics/export/transactions?limit=3")
...
class TestUploadBankStatementValidFile:
    ...
    def test_upload_valid_bank_statement(self, auth_client: TestClient):
        ...
        response = auth_client.post("/api/analytics/upload-bank-statement", files=files)
    ...
    def test_upload_creates_bank_statement_record(self, auth_client: TestClient):
    ...
    def test_upload_with_cp1251_encoding(self, auth_client: TestClient):
...
class TestUploadBankStatementValidation:
    ...
    def test_upload_case_insensitive_extension(self, auth_client: TestClient):
    ...
    def test_upload_no_extension_rejected(self, auth_client: TestClient):
...
class TestUploadBankStatementFileSize:
    ...
    def test_upload_exceeds_5mb_limit(self, auth_client: TestClient):
    ...
    def test_upload_at_5mb_limit_accepted(self, auth_client: TestClient):
    ...
    def test_upload_small_file_accepted(self, auth_client: TestClient):
...
class TestUploadBankStatementParserErrors:
    ...
    def test_upload_invalid_format(self, auth_client: TestClient):
    ...
    def test_upload_corrupted_encoding(self, auth_client: TestClient):
...
class TestUploadBankStatementWithMatching:
    ...
    def test_upload_with_matching_invoices(self, auth_client: TestClient):
        ...
        upload_response = auth_client.post("/api/analytics/upload-bank-statement", files=files)
